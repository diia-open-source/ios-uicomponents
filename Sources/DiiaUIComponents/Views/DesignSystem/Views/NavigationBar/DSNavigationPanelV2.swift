...
public final class DSNavigationPanelV2View: BaseCodeView {
    ...
    override public func setupSubviews() {
        ...
        smallTitle.anchor(leading: backButton.trailingAnchor,
                          padding: .init(top: 0, left: Constants.leftPadiing, bottom: 0, right: 0))
    ...
    public func configure(data: DSNavigationPanelV2, eventHandler: @escaping (ConstructorItemEvent) -> Void) {
        ...
        smallTitle.isHidden = data.title == nil
        backButton.isHidden = data.iconLeft == nil
        if let leftIcon = data.iconLeft {
