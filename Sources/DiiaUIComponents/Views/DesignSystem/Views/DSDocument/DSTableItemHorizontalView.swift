...
public class DSTableItemHorizontalView: BaseCodeView {
    ...
    private lazy var valueButtonStack = UIStackView.create(.horizontal,
                                                           views: [valueLabel],
    ...
    private lazy var stack = UIStackView.create(.horizontal,
                                                views: [supportLabel, titleStack, valueStack, UIView(), iconView],
                                                spacing: Constants.bigStackSpacing,
                                                alignment: .top)
...
public extension DSTableItemHorizontalView {
    enum Constants {
        ...
        static let doubleSpacing: CGFloat = 8
