...
public struct DSRadioBtnMlcV2Model: Codable {
    ...
    public init(componentId: String, id: String?, iconLeft: DSIconModel?, iconRight: DSIconModel?, iconBigRight: DSIconModel?, label: String, description: String?, descriptions: [String]?, status: String?, isSelected: Bool?, isEnabled: Bool?, dataJson: AnyCodable?) {
